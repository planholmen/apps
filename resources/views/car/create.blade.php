            ...
            <form action="/cars" method="post">
                ...
                <div class="text-2xl mt-6 text-left w-10/12 mx-auto bg-white p-4 px-8 rounded-lg">
                    ...
                    <div class="my-8 py-4">
                        ...
                        <input class="w-full border-solid border-gray-400 border-2 rounded-lg" type="text" name="license_plate" required>
                        @error('license_plate')
                    ...
                    <div class="my-8 py-4">
                        <input class="block mx-auto px-12 py-4 bg-green-500 text-white rounded-lg cursor-pointer" type="submit" name="submit" value="Opret!">
                    </div>
